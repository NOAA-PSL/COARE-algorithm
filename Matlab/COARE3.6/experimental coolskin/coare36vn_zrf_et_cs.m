...
%%%%%%%%%%%%%   code added to call analytic cool skin
u10nx = usr./von.*log(10./zo);
cdt = (0.9-0.4.*u10nx./25)*1e-3;
ustan = u10nx.*sqrt(cdt);
usrw=ustan.*(sqrt(rhoa./rhow));
[dter2 tkt2]=dcoolf2(usrw,ts,xlamx/6,qout,sw_net);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
